          ...
          <div className="flex lg:justify-between mobile:justify-between  px-0 mobile:pt-5 pt-0 mobile:w-full tab:w-auto">
            <div className="lg:pr-16 lgdesktop:pr-28 pr-0 w-2/4 lg:w-auto ">
              ...
              <Link
                ...
                className={`${manrope.className} text-form-head leading-6 text-left head-14 mobile:leading-4 tab:w-10/12 lgdesktop:w-auto  hover:text-prime-green`}
              >
            ...
            <div>
              ...
              <Link
                href={"tel:02268493501"}
                target="_blank"
                className={`${manrope.className} text-form-head lg:text-xl text-lg leading-5 head-14 mobile:leading-4 font-semibold pb-1 hover:text-prime-green block`}
              >
                +022-6849-3501
              </Link>
              <Link
                ...
                target="_blank"
                className={`${manrope.className} block text-form-head lg:text-xl text-lg leading-5 head-14 mobile:leading-4 font-semibold pb-1  hover:text-prime-green`}
              >
                +91 915- 238- 7077
              </Link>
              <Link
                href={"mailto:vestate@inkincaps.com"}
                className={`${manrope.className} text-form-head head-14 text-lg font-semibold leading-5 hover:text-prime-green`}
              >
                vestate@inkincaps.com
              </Link>
              <div className="flex gap-2.5 pt-6">
                <Link
                  href={"https://www.instagram.com/inkincaps/"}
                  target="_blank"
                >
                  <svg
                    width="24"
                ...
                <Link
                  className=""
                  href={
                    "https://www.linkedin.com/company/ink-in-caps/?originalSubdomain=in"
                  }
                  target="_blank"
                >
                  <svg
                ...
                <Link href={"https://wa.me/+919152387077"} target="_blank">
                  <svg
                    width="24"
                    height="25"
                    viewBox="0 0 24 25"
